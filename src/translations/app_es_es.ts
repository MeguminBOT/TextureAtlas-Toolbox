...
• Custom: configure each setting manually</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>Preajustes rápidos:
- Sin pérdidas: recomprime sin cambios de color
- En todas partes: general-purpose lossy (256 colores)
- Pixel Art: bordes nítidos, sin difuminado.
- Heavy Transparency: mejor para sprites semitransparentes.
- Agresivo: reducción de tamaño máxima (64 colores)
...
• Custom: use the individual settings below</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>El preajuste predeterminado que se aplica cuando se abre la pestaña Optimizar.
- Sin pérdidas: recomprime sin cambios de color
- En todas partes: general-purpose lossy (256 colores)
- Pixel Art: bordes nítidos, sin difuminado.
- Heavy Transparency: mejor para sprites semitransparentes.
...
0 = Sin compresión (el más rápido)
...
• Grayscale + Alpha / Grayscale</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>Conversión del modo de color:
- Mantener original: Sin cambios
- RGBA: 32 bits con alfa
- RGB: 24 bits, alfa eliminado
...
dramatically reduce file size.</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>Reducir la imagen a una paleta indexada con un número limitado
limitado de colores (como pngquant). Esto tiene pérdidas, pero puede
...
• ImageMagick: Best RGBA quantization (requires Wand)</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>Algoritmo de cuantificación:
- Corte medio: Buen equilibrio entre calidad y velocidad
- Cobertura máxima: mejor representación del color
- Octree rápido: Más rápido, calidad aceptable
- libimagequant: Cuantificador de alta calidad
  (requiere Pillow compilado con libimagequant)
- pngquant: cuantización alfa premultiplicada
  (mejor para sprites con bordes semitransparentes)
...
• Riemersma: Hilbert-curve error-diffusion,
  organic noise pattern (requires Wand/ImageMagick)</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>El difuminado reduce las bandas de color en imágenes cuantizadas:
- Floyd-Steinberg: difuminado clásico por difusión de errores
- Ordenado (Bayer): patrón de puntos regular,
  se comprime muy bien con PNG
- Ruido azul: Ruido uniforme sin artefactos de cuadrícula,
  visualmente agradable y se comprime bien
- Atkinson: Difusión de error ligera (3/4 de error),
  nítido y de alto contraste (más lento en imágenes grandes)
- Riemersma: Difusión de errores con curva de Hilbert,
...
(when 'Skip if larger' is enabled).</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>Sustituye los archivos originales por versiones optimizadas.
Sólo sustituye si el nuevo archivo es realmente más pequeño
...
KTX2 — Khronos Texture 2, supports all formats including mobile.</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>Archivo contenedor de la textura comprimida.

DDS - DirectDraw Surface, ampliamente soportado en ordenadores de sobremesa y consolas.
...
reduce aliasing artifacts.</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>Genera una cadena de mipmap completa para la textura del atlas.

Los mipmaps mejoran la calidad del renderizado cuando la textura se
se muestra más pequeña que su resolución nativa y puede
...
Set to 'None' to output standard images.</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>Formato de compresión de texturas GPU.
...
The main animation itself will always be available regardless of this setting.</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>Cuando está activada, sólo se muestran los símbolos que forman parte de la línea de tiempo de la animación principal.
Los símbolos componentes (partes del cuerpo, efectos, etc.) que no sean animaciones independientes se ocultarán.
...
This is useful when you only want the full composed animation output.</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>Cuando está activada, sólo la animación raíz principal será listada para su extracción.
Las líneas de tiempo de los símbolos individuales y las etiquetas de las líneas de tiempo serán excluidas.
...
derive the animation name (legacy behaviour).</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>Utilice el análisis por lotes para detectar límites de animación
al extraer hojas de sprites e importar atlas.

Cuando se activa esta opción, las secuencias subíndices como Anim10001..Anim20003
se analizan como un grupo para decidir si el subíndice
(1, 2, ...) representan animaciones separadas o una sola
con un recuento de fotogramas continuo.

Cuando está desactivado, los dígitos finales simplemente se eliminan para obtener el nombre de la animación (comportamiento heredado).
...
or external CLI tools for ASTC/PVRTC.</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>Produce un archivo comprimido por la GPU junto con el PNG optimizado.

Requiere etcpak (pip install etcpak) para formatos BC/ETC,
...
KTX2 — Khronos Texture 2 (cross-platform, all formats).</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>DDS - DirectDraw Surface (escritorio/consola).
...
when the texture is displayed at reduced sizes.</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>Genera una cadena completa de mipmaps para un mejor renderizado
...
{error}</source>
            <translatorcomment>[marker:machine] [machine]</translatorcomment>
            <translation>Se ha producido un error durante la optimización:
{error}</translation>
        </message>
        <message>
...
Utilízalo sólo cuando sepas que tu motor o renderizador de destino soporta el formato elegido. Una configuración incorrecta puede producir archivos corruptos o que no se carguen.

Puntos clave:
- Los contenedores DDS sólo soportan formatos BC (DXT); los formatos móviles (ETC, ASTC, PVRTC) requieren KTX2.
- ASTC y PVRTC necesitan herramientas CLI externas instaladas por separado (astcenc / PVRTexToolCLI).</translation>
        </message>
    </context>
    <context>
